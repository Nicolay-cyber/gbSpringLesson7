...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler
    public ResponseEntity<AppError> catchCartException(CartException e){
        return new ResponseEntity<>(new AppError(HttpStatus.BAD_GATEWAY.value(), e.getMessage()),HttpStatus.BAD_GATEWAY);
    }
    @ExceptionHandler
    public ResponseEntity<FieldsValidationError> catchValidationException(ValidatorException e) {
